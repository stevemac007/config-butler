...
version = {}
with open(path.join(here, 'configbutler/_version.py')) as fp:
...
setup(
    ...
    description='Service to manage generation of server config from various configuration sources',
    ...
    entry_points={
        'console_scripts': [
            'configbutler=configbutler.main:main',
        ],
    },
